...
public class oStateActionUser : oStateMachine
{
    ...
    public void GetCardClick(Guid CardID)
    {
        _gm.DoUnitCardClick(CardID);
        oStateViewCard vCard = new oStateViewCard();
        vCard.UnitGuid = CardID;
        _gm.AddState(vCard);
